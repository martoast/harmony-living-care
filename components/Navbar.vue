      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden md:ml-6 md:flex md:space-x-8">
            ...
            <NuxtLink to="/about" :class="linkClass('/about')">About us</NuxtLink>
            ...
            <div class="relative inline-flex h-full group"
              ...
              <div v-show="dropdowns.communities" class="absolute left-0 top-full mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50" role="menu" aria-orientation="vertical" aria-labelledby="communities-menu">
                <div class="py-1" role="none">
                  ...
                  <NuxtLink to="/communities/?address=alabama" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Alabama</NuxtLink>
                  <NuxtLink to="/communities/?address=arizona" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Arizona</NuxtLink>
                  ...
                  <NuxtLink to="/communities/?address=florida" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Florida</NuxtLink>
