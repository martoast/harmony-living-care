          ...
          <div class="mt-10 lg:col-start-1 lg:row-start-1 lg:mt-0 lg:self-center">
            <div class="lg:max-w-lg">
              ...
              <form @submit.prevent="submitForm" class="mt-10">
                <label for="location" class="block text-sm font-medium text-gray-700 mb-3">Enter zip code or city and state</label>
                <div class="mt-1 flex rounded-md shadow-sm">
                  <input type="text" name="location" id="location" required class="block w-full rounded-md border-gray-300 px-4 py-3 focus:border-red-500 focus:ring-red-500 sm:text-sm" placeholder="Enter location">
