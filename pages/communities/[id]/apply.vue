<template>
  <div class="px-6 py-12 sm:py-24 lg:px-0">
    <div class="max-w-2xl lg:mx-auto my-12">
      <form @submit.prevent="submitForm">
        <div class="space-y-12">
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <p class="mt-1 text-sm leading-6 text-gray-600">
              Please provide information about the person applying for assisted
              living.
            </p>
                  ...
                  <div class="relative flex gap-x-3">
                    <div class="flex h-6 items-center">
                      <input
                        ...
                        type="checkbox"
                        v-model="form.services.assistedLiving"
                  ...
                  <div class="relative flex gap-x-3">
                    <div class="flex h-6 items-center">
                      <input
                        ...
                        type="checkbox"
                        v-model="form.services.independentLiving"
                        class="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-600"
                      />
                    </div>
                    <div class="text-sm leading-6">
                      ...
                      >
                      <p class="text-gray-500">
                        For those who can live independently but want community
                        and amenities.
                      </p>
                    </div>
                  </div>
                  <div class="relative flex gap-x-3">
                    <div class="flex h-6 items-center">
                      <input
                        ...
                        name="memory-care"
                        type="checkbox"
                        v-model="form.services.memoryCare"
                        class="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-600"
                      />
                    </div>
                    <div class="text-sm leading-6">
                      <label for="memory-care" class="font-medium text-gray-900"
                        >Memory Care</label
                      >
                      <p class="text-gray-500">
                        Specialized care for those with memory-related
                        conditions.
                      </p>
                    </div>
                  </div>
                  <div class="relative flex gap-x-3">
                    <div class="flex h-6 items-center">
                      <input
                        ...
                        type="checkbox"
                        v-model="form.services.skilledNursing"
                        class="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-600"
                      />
                    </div>
                    <div class="text-sm leading-6">
          ...
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <p class="mt-1 text-sm leading-6 text-gray-600">
              Please provide relevant health information to help us better
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="col-span-full">
                <label
                  ...
                  class="block text-sm font-medium leading-6 text-gray-900"
                  >Current Medical Conditions</label
                >
                <div class="mt-2">
                  <textarea
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
          <a :href="'/communities/' + route.params.id"
            ><button
              type="button"
          ...
          <button
            :disabled="loading"
            type="submit"
            class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
          >
            Submit Application
          </button>
        </div>
...
const submitForm = async () => {
  ...
  const payload = {
    lead: { ...form.value, ...property.value },
  };

  try {
    await $fetch("/api/patient-application-webhook", {
      method: "POST",
      headers: {
