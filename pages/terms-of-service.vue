<template>
  ...
  <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
    ...
    <p class="mt-6 text-xl leading-8">Last Updated: 07/02/2024</p>
    
    <p class="mt-6">Welcome to Harmony Homecare. These Terms of Service ("Terms") govern your access to and use of Harmony Homecare's website, services, and applications (the "Service"). Please read these Terms carefully, and contact us if you have any questions. By accessing or using our Service, you agree to be bound by these Terms and our Privacy Policy.</p>

    <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">1. Definitions</h2>
    <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
      <li class="flex gap-x-3">
        <span><strong class="font-semibold text-gray-900">"Company"</strong> refers to Harmony Homecare, 1401 21st Street Suite R
Sacramento California 95811.</span>
      </li>
      <li class="flex gap-x-3">
        <span><strong class="font-semibold text-gray-900">"Service"</strong> refers to the website, applications, and services provided by Harmony Homecare.</span>
      </li>
      <li class="flex gap-x-3">
    ...
    <p class="mt-6">You may use our Service only if you can form a binding contract with Harmony Homecare, and only in compliance with these Terms and all applicable laws. When you create your Harmony Homecare account, you must provide us with accurate and complete information. Any use or access by anyone under the age of 18 is prohibited.</p>
    ...
    <p class="mt-6">The Service and its original content, features, and functionality are and will remain the exclusive property of Harmony Homecare and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Harmony Homecare.</p>

    <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">6. Links to Other Websites</h2>
    <p class="mt-6">Our Service may contain links to third-party websites or services that are not owned or controlled by Harmony Homecare. Harmony Homecare has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party websites or services.</p>
    ...
    <p class="mt-6">In no event shall Harmony Homecare, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
    ...
    <p class="mt-6">These Terms shall be governed and construed in accordance with the laws of Texas, United States of America, without regard to its conflict of law provisions.</p>
    ...
    <p class="mt-6">If you have any questions about these Terms, please contact us at esteban@Harmony Homecare.io</p>
  </div>
</div>
</template>